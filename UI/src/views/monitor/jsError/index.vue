...
<el-form-item label="发生时间">
  ...
  :rows="4" v-model="temp.errorMessage" disabled></el-input>
      </el-form-item>
         <el-form-item label="错误堆栈">
      <el-input  type="textarea"
  :rows="4" v-model="temp.errorStack" disabled></el-input>
      </el-form-item>
...
import { getJavascriptErrorList } from '@/api/monitor/analysis'
...
export default {
  ...
  actionMessage: function (value) {
    var message = '错误信息:'+value.errorMessage
    return message;
  }
  },
  data() {
  ...
  methods: {
    ...
    getList() {
        ...
        getJavascriptErrorList(this.listQuery).then(response => {
