...
<el-form-item label="发生时间">
      ...
      <el-input v-model="temp.tagName" disabled></el-input>
      </el-form-item>
        
        <el-form-item label="行为">
      <el-input v-model="temp.behaviorType" disabled></el-input>
      </el-form-item>
        <el-form-item label="样式">
      <el-input v-model="temp.className" disabled></el-input>
      </el-form-item>
        <el-form-item label="值">
      <el-input v-model="temp.inputValue" disabled></el-input>
      </el-form-item>
        <el-form-item label="placeholder">
      <el-input v-model="temp.placeholder" disabled></el-input>
      </el-form-item>
      <el-form-item label="innerText">
      <el-input v-model="temp.innerText" disabled></el-input>
      </el-form-item>
...
import { getBehaviorList } from '@/api/monitor/analysis'
...
export default {
  ...
  methods: {
    ...
    getList() {
        ...
        getBehaviorList(this.listQuery).then(response => {
