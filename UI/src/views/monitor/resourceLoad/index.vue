...
<el-form-item label="发生时间">
      ...
      <el-input v-model="temp.sourceUrl" disabled></el-input>
      </el-form-item>
        <el-form-item label="类型">
      <el-input v-model="temp.elementType" disabled></el-input>
      </el-form-item>
       <el-form-item label="加载状态">
      <el-input v-model="temp.elementType=='1'?'成功':'失败'" disabled></el-input>
      </el-form-item>
...
import { getResourceLoadList } from '@/api/monitor/analysis'
...
export default {
  ...
  actionMessage: function (value) {
    var message = '地址：'+value.sourceUrl
    return message;
  }
  },
  data() {
  ...
  methods: {
    ...
    getList() {
        ...
        getResourceLoadList(this.listQuery).then(response => {
