...
<el-form-item label="发生时间">
     ...
     <img :src=" temp.keyId | getImageUrl "  > </img>
      </el-form-item>
...
import { getScreenShotList } from '@/api/monitor/analysis'
...
export default {
  ...
  getImageUrl: function (value) {
    var url = process.env.BASE_API+"upload-log/image?keyId="+value
    return url;
  }
  },
  data() {
  ...
  methods: {
    ...
    getList() {
        ...
        getScreenShotList(this.listQuery).then(response => {
