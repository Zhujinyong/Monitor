...
<el-form-item label="发生时间">
 ...
 <el-form-item label="日志分类">
      <el-input v-model="temp.uploadType" disabled></el-input>
      </el-form-item>
        <el-form-item label="行为类型">
      <el-input v-model="temp.behaviorType" disabled></el-input>
      </el-form-item>
        <el-form-item label="行为结果">
      <el-input v-model="temp.behaviorResult" disabled></el-input>
      </el-form-item>
...
import { getExtendBehaviorList } from '@/api/monitor/analysis'
...
export default {
  ...
  methods: {
    ...
    getList() {
        ...
        getExtendBehaviorList(this.listQuery).then(response => {
