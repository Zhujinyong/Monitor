...
<el-form-item label="发生时间">
      ...
      <el-input v-model="temp.loadPage" disabled></el-input>
      </el-form-item>
        
        <el-form-item label="Dom渲染时间">
      <el-input v-model="temp.domReady" disabled></el-input>
      </el-form-item>
        <el-form-item label="redirect">
      <el-input v-model="temp.redirect" disabled></el-input>
      </el-form-item>
        <el-form-item label="lookupDomain">
      <el-input v-model="temp.lookupDomain" disabled></el-input>
      </el-form-item>
        <el-form-item label="ttfb">
      <el-input v-model="temp.ttfb" disabled></el-input>
      </el-form-item>
      <el-form-item label="request">
      <el-input v-model="temp.request" disabled></el-input>
      </el-form-item>
       <el-form-item label="loadEvent">
      <el-input v-model="temp.loadEvent" disabled></el-input>
      </el-form-item>
       <el-form-item label="appcache">
      <el-input v-model="temp.appcache" disabled></el-input>
      </el-form-item>
       <el-form-item label="unloadEvent">
      <el-input v-model="temp.unloadEvent" disabled></el-input>
      </el-form-item>
       <el-form-item label="CONNECT">
      <el-input v-model="temp.CONNECT" disabled></el-input>
      </el-form-item>
       <el-form-item label="loadType">
...
import { getLoadPageList } from '@/api/monitor/analysis'
...
export default {
  ...
  actionMessage: function (value) {
    var message = '耗时：'+value.loadPage+'ms'
    return message;
  }
  },
  data() {
  ...
  methods: {
    ...
    getList() {
        ...
        getLoadPageList(this.listQuery).then(response => {
