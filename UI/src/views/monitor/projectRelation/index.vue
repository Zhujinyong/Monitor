...
<script>
import { getProjectRelationTreeList,addProjectRelation,deleteProjectRelation } from '@/api/monitor/projectRelation'
import { newGuid } from '@/utils/index'
import { getProjectList } from '@/api/monitor/project'
import { getSvnJenkinsList,addSvnJenkins,UpdateSvnJenkins } from '@/api/monitor/jenkins'
