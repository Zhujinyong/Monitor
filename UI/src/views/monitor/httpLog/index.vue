...
<el-form-item label="发生时间">
      ...
      <el-input v-model="temp.httpUrl" disabled></el-input>
      </el-form-item>
        
        <el-form-item label="状态码">
      <el-input v-model="temp.status" disabled></el-input>
      </el-form-item>
        <el-form-item label="statusText">
      <el-input v-model="temp.statusText" disabled></el-input>
      </el-form-item>
        <el-form-item label="备注">
      <el-input v-model="temp.statusResult" disabled></el-input>
      </el-form-item>
...
import { getHttpLogList } from '@/api/monitor/analysis'
...
export default {
  ...
  actionMessage: function (value) {
    var message = value.statusResult+',状态码:'+value.status
    return message;
  }
  },
  data() {
  ...
  methods: {
    ...
    getList() {
        ...
        getHttpLogList(this.listQuery).then(response => {
