<template>
  <div class="app-container">
     ...
     <el-input style="width: 200px;"  v-model="listQuery.projectName" placeholder="请输入项目名称" clearable @change="resetPageIndex"></el-input>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogVisible" :close-on-click-modal="false">
      ...
      <el-input v-model="temp.projectName" placeholder="请输入"></el-input>
      </el-form-item>
...
<script>
import { getProjectList,addProject,updateProject } from '@/api/system/project'
